...
srdb <- read.csv("srdb-data-V5.csv", stringsAsFactors = FALSE)
message("Rows = ", nrow(srdb), ", columns = ", ncol(srdb))

message("Reading fields data file...")
srdb_info <- read.csv("srdb-data_fields_V5.txt", sep = ",", comment.char = "#", stringsAsFactors = FALSE)
...
srdb_studies <- read.csv("srdb-studies-V5.csv", stringsAsFactors = FALSE)
message("Rows = ", nrow(srdb_studies), ", columns = ", ncol(srdb_studies))

message("Reading studies info file...")
srdb_studies_info <- read.csv("srdb-studies_fields_V5.txt", sep = ",", comment.char = "#", stringsAsFactors = FALSE)
message("Rows = ", nrow(srdb_studies), ", columns = ", ncol(srdb_studies))
